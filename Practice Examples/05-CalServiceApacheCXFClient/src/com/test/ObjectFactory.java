...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://test.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://test.com/", "addResponse");
    private final static QName _Sub_QNAME = new QName("http://test.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://test.com/", "subResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "sub")
     ...
     */
    @XmlElementDecl(namespace = "http://test.com/", name = "subResponse")
